            ...
            <div className="grid grid-cols-7 text-xs relative z-0">
                {days.map((day, idx) => {
                    ...
                    return (
                        ...
                        >
                            <div className="absolute top-1 left-1 text-[11px]">{format(day, "dd")}</div>
                                ...
                                {Array.from({ length: nextLineIndex }).map((_, lineIdx) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            title={`#${tourAtLine.id} - ${tourAtLine.max_people} chỗ\n${format(start, "dd/MM")} → ${format(end, "dd/MM")}`}
                                        >
                                            ...
                                            {isStart && (
                                                <span className="truncate pl-4 z-10">  {tourName} - {tourAtLine.max_people} chỗ</span>
                                            )}
                                        </div>
