...
export default function LoginForm() {
    ...
    return (
        <div className="  w-[400px]">
            <h2 className="text-2xl font-semibold text-center mb-4">Chào mừng trở lại</h2>
            <p className="text-gray-500 text-center mb-6">Đăng nhập bằng tài khoản Google của bạn</p>
            ...
            <p className="text-center text-gray-600 mt-4">
                Chưa có tài khoản? <a href="register" className="text-red-500 hover:underline">Đăng ký ngay</a>
            </p>
        </div>
    );
}