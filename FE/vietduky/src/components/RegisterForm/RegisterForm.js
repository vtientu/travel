        ...
        <div className=" w-[400px]">
            ...
            <div className="text-sm text-gray-600 mb-4">
                <div className="flex items-center">
                    <input type="checkbox" className="mr-2" checked disabled /> Phải có ít nhất 8 ký tự
                </div>
                <div className="flex items-center">
                    <input type="checkbox" className="mr-2" checked disabled /> Phải chứa một ký tự đặc biệt
                </div>
            </div>
