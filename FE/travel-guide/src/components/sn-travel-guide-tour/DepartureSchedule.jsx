...
import TourScheduleModal from "./TravelTourModal";
import { getGuideTourCanAccept } from "../../services/API/guide-tour.service";
...
const DepartureSchedule = () => {
  ...
  useEffect(() => {
    const fetchTours = async () => {
      setLoading(true);
      try {
        const response = await getGuideTourCanAccept();
