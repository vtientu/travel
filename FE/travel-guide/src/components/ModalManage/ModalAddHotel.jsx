...
export default function ModalAddHotel({ onClose }) {
      ...
      <div className="bg-white rounded-md shadow-lg w-1/4 p-6" onClick={handleModalClick}>
        <form>
          ...
          <div>
            {/* Tên khách sạn */}
            <div className="mb-4">
              <label className="block font-medium mb-1 before:content-['*'] before:text-red-500 before:mr-1">Tên khách sạn</label>
              <input
                type="text"
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                className="w-full border rounded-md p-2"
                placeholder="Nhập địa chỉ của khách sạn"
                value={locationHotel}
